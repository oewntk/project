...
**Supplier-consumer chains**: YAML2SQL, YAML2WNDB, YAML2SER, XML2WNDB, WNDB2SER, etc.
...
-   [grind_yaml2plus](http://github.com/oewntk/grind_yaml2json) : Chain from YAML supplier to YAML consumer, generating missing entries
